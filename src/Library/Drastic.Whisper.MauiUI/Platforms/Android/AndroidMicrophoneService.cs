// <copyright file="AndroidMicrophoneService.cs" company="Drastic Actions">
...
namespace Drastic.Whisper.MauiUI.Platforms
{
    public class AndroidMicrophoneService : IMicrophoneService
    {
        ...
        public static bool IsEnabled
        {
            get
            {
                return Android.App.Application.Context.PackageManager.HasSystemFeature(PackageManager.FeatureMicrophone)
                       && Android.App.Application.Context.PackageManager.CheckPermission(
                           "android.permission.RECORD_AUDIO",
                           Android.App.Application.Context.PackageName) == Permission.Granted;
            }
        }
        ...
        /// </summary>
        public event EventHandler<AudioCapturedEventArgs> OnBroadcast;
        ...
        private async Task Record()
        {
            ...
            OnBroadcast.Invoke(this, new AudioCapturedEventArgs(buffer));
        }
    }
}