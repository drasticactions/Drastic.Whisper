// <copyright file="iOSMicrophoneService.cs" company="Drastic Actions">
...
namespace Drastic.Whisper.MauiUI.Platforms
{
    public class iOSMicrophoneService : IMicrophoneService
    {
        ...
        public iOSMicrophoneService(int bufferSize = 4098)
        {
        ...
        private void QueueInputCompleted(object sender, InputCompletedEventArgs e)
        {
            ...
            if (OnBroadcast != null)
            {
                ...
                OnBroadcast(this, new AudioCapturedEventArgs(send));
            }
